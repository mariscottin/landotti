...
const Method = () => {
    ...
    return (
        <div className="method__container section" id="methodSection">
            <h1 className="section-title"><Fade>Method</Fade></h1>
                            ...
                            <Carousel activeIndex={index} onSelect={handleSelect} fade={true} indicators={false}>
                                <Carousel.Item>
                                    <div className="carousel-item__container">
                                        <h3>1. Approach <span><img src={Approach} alt="Project Approach" /></span></h3>
                                        <p>
                                ...
                                <Carousel.Item>
                                    <div className="carousel-item__container">
                                        <h3>2. Initiation <span><img src={Initiation} alt="Project Initiation" /></span></h3>
                                        <p>
                                ...
                                <Carousel.Item>
                                    <div className="carousel-item__container">
                                        <h3>3. Planning <span><img src={Planning} alt="Project Planning" /></span></h3>
                                        <p>
                                ...
                                <Carousel.Item>
                                    <div className="carousel-item__container">
                                        <h3>4. Execution <span><img src={Execution} alt="Project Execution" /></span></h3>
                                        <p>
                                ...
                                <Carousel.Item>
                                    <div className="carousel-item__container">
                                        <h3>5. Monitoring &amp; Control <span><img src={Monitoring} alt="Project Monitoring &amp; Control" /></span></h3>
                                        <p>
                                ...
                                <Carousel.Item>
                                    <div className="carousel-item__container">
                                        <h3>6. Closure <span><img src={Closure} alt="Project Closure" /></span></h3>
                                        <p>
